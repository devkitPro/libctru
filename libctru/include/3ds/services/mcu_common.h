...
typedef enum MCU_InterruptNotification
{
...
} MCU_InterruptNotification;

/// MCU interrupts.
typedef enum MCU_Interrupt
{
...
typedef enum MCU_ResetEventFlags
{
...
typedef enum MCU_PowerStatusFlags
{
